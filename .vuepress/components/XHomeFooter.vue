  ...
  <div class="footer-wrapper">
    <span>
      <Xicons
        target="_blank"
        icon="XIconGithub"
        :text="`Hellolib · Apache 2.0`"
        link="https://github.com/hellolib/chat-copilot"
      />
    </span>
...
import { IconColorPalette, IconGithub, IconSecurity, IconEye, IconCopyRight } from '@components/icons/index.js'
